...
async function getAverage(latestRef, averageRef){
  ...
  const newAverage = averageObjects(latestData, averageData)
  ...
  else if(!newAverage || !averageData || !averageData.count || !averageData.chain || !averageData.market || !averageData.pool){
